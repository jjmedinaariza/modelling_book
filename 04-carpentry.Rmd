...
It would be quicker to recode from *d15a* into a new variable (there would be less typing when dealing with numbers rather tham labels). But here we are going to use this example to show you how to recode from a factor variable, so instead we will recode form *f_occup*. 
